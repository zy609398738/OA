...
Ext.define('Ext.calendar.form.field.DateRange', {
     ...
     */
    timeFormat: 'G:i', //Ext.Date.use24HourTime ? 'G:i' : 'g:i A',
    ...
    getStartDateConfig: function() {
        return {
            ...
            name: Ext.calendar.data.EventMappings.StartDate.name,
            width: 100,
            listeners: {
                'blur': {
                    fn: function(){
    ...
    getEndDateConfig: function() {
        return {
            ...
            name: Ext.calendar.data.EventMappings.EndDate.name,
            format: this.dateFormat,
            hideLabel: true,
            width: 100,
            listeners: {
    ...
    getAllDayConfig: function() {
        return {
            ...
            name: Ext.calendar.data.EventMappings.IsAllDay.name,
