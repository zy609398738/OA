...
//                    );
    ...
    /*_.fn.live = function(evtName, handler) {
        _(document).on(evtName, this.selector, handler);
        return this;
    };

    _.fn.die = function(evtName, handler) {
        _(document).off(evtName, this.selector, handler);
        return this;
    };*/
}(window.jQuery);