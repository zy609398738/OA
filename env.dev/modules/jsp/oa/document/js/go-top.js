...
GoTop = function() {
	...
	this.config = {
		...
		distanceToBottom	:125,		// Go Top 节点上边到页面底部的距离
		distanceToPage		:20,		// Go Top 节点左边到页面右边的距离
		hideRegionHeight	:180,		// 隐藏节点区域的高度 (该区域从页面顶部开始)
		path			:''			// Go Top 的文本内容
	};
...
GoTop.prototype = {
	...
	_insertNode: function(args) {
		...
		var topLink = jQuery('<a id="' + _self.config.nodeId + '" href="#">' +'<img src="'+ _self.config.path + '"/>'+ '</a>');
