...
<%!
    ...
    public void setupRequestAttributesForPagination(HttpServletRequest request, String containerCssSelector) {
        ...
        Map<String, ? extends Object> params = request.getParameterMap();
	...
	private static final Map<String, String> poorBillNames = new HashMap<String, String>();
    static {
        poorBillNames.put("subsys_SCM_draft", "拟稿");
        poorBillNames.put("subsys_SCM_directOutgoingMsg", "直发文");
        poorBillNames.put("subsys_SCM_incomingMsg", "来文登记");
        poorBillNames.put("subsys_SCM_briefReport", "简报");
    }
    ...
    public boolean redirectOnNonAjaxRequest(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (reqWith != null && reqWith.equalsIgnoreCase("XMLHttpRequest")){
            return false;
        }
        resp.setStatus(HttpServletResponse.SC_MOVED_TEMPORARILY);
        resp.sendRedirect("index.jsp?_preload=" +
                URLEncoder.encode(String.format("%s?%s", req.getRequestURI(), nvl(req.getQueryString(),"")), "UTF-8"));
        return true;
    }
%>