void function(Ext, jq){
    ...
    var backwards = {
        //'': backToIndex,
        'todolist': backTo('workflow_forme.jsp?workflowtype=1'), // 待办 
		'toReadList': backTo('workflow_forread.jsp?readtype=0&wftype=1'), // 待阅
        'DoneList': backTo('workflow_forme.jsp?workflowtype=3'), // 已办
		'HasReadList': backTo('workflow_forread.jsp?readtype=1&wftype=1'), // 已阅
		'FinishedList': backTo('workflow_forme.jsp?workflowtype=4'), // 结束
		'FromMeList': backTo('workflow_forme.jsp?workflowtype=5'), // 我发起
		'DraftList': backTo('workflow_forme.jsp?workflowtype=6'), // 草稿
		'rejectList': backTo('workflow_forme.jsp?workflowtype=2')
    };
