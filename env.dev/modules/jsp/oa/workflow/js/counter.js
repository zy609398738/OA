void function(_) {
    ...
    var MAP_COUNTER_URL = {
			...
			+ '/rfc.do?__webCall=1&__out=1&__exp=wf.WorkFlowAction.GetDoReadCount(GetCuroperator(),%7Btodolist%7D,%7B and wftype=1%7D)&noAlert=1',
            'to-read': MAP_C_SERVER_URL 
			+ '/rfc.do?__webCall=1&__out=1&__exp=wf.WorkFlowAction.GetDoReadCount(GetCuroperator(),%7Btoreadlist%7D,%7B and wftype=1%7D)&noAlert=1',
			'reject' : MAP_C_SERVER_URL 
			+ '/rfc.do?__webCall=1&__out=1&__exp=wf.WorkFlowAction.GetDoReadCount(GetCuroperator(),%7Brejectlist%7D,%7B and wftype=1%7D)&noAlert=1',
			'done' : MAP_C_SERVER_URL 
			+ '/rfc.do?__webCall=1&__out=1&__exp=wf.WorkFlowAction.GetDoReadCount(GetCuroperator(),%7Bdonelist%7D,%7B and wftype=1%7D)&noAlert=1',
			'did' : MAP_C_SERVER_URL 
			+ '/rfc.do?__webCall=1&__out=1&__exp=wf.WorkFlowAction.GetDoReadCount(GetCuroperator(),%7Bdidlist%7D,%7B and wftype=1%7D)&noAlert=1'
        },
