...
<html>
	<head>
        ...
        .login-main {
            background-image: url(yigo2-theme/images/login/background.jpg);
	...
	<body>
    	...
    	<div class="header">
    		<div class="warpper">
				<img class="login-logo" src="yigo2-theme/images/login/logo.png"><!-- 
			 --><span class="login-logo-text">成就客户 开放心胸 全力以赴 追求卓越</span>
    		</div>	
    	</div>
    	<div class="login-main">
			<div class="warpper">
				<img class="login_img" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"><!-- 
