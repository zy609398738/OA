...
public class TSL_CheckContractNonCN implements IExtService2 {
	private static String[] headFields = { "OU_NAME", "TradeTerms", "Currency", "CustomerName", "Region", "SubRegion",
			...
			"HowMuchImpactUSD", "RelatedParty", "CreditTerms", "OutOfCredit", "IsReplaced", "TotalCM", "RateCode",
			"RateRMB", "TotalAmountUSD", "CustomerID", "Cur_CODE", "RateUSD", "IsRegion", "ContractBarcodeID" };
