...
public class ImportDtlTableHandler
{
  ...
  public ImportDtlTableHandler(DefaultContext context, Workbook workbook,Integer sheetindex)
    throws Throwable
  {
    this.metaFactory = context.getVE().getMetaFactory();
    this.workbook = workbook;
    this.context = context;
    init(context,sheetindex);
  }

  private void init(DefaultContext context,Integer sheetindex) throws Throwable {
    this.formKey = context.getFormKey();

    this.mainSheet = this.workbook.getSheetAt(sheetindex);
