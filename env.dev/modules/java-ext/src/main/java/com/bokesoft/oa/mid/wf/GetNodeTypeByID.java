 ...
 *
 */
public class GetNodeTypeByID implements IExtService {
	@Override
	public Object doCmd(DefaultContext paramDefaultContext, ArrayList<Object> paramArrayList) throws Throwable {
		return getNodeTypeByID(paramDefaultContext, TypeConvertor.toString(paramArrayList.get(0)),
	 ...
	 * @throws Throwable
	 */
	public String getNodeTypeByID(DefaultContext context, String workflowKey, Integer workflowVersion) throws Throwable {
		String dropItem = "";
		...
		if (process == null) {
			String err = OAStrUtil.localeString(context, "oa", "reset_the_process");
			throw new Error(err);
