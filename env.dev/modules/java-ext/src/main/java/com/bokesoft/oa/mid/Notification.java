...
public class Notification implements IExtService {
	...
	public Object doCmd(DefaultContext defaultContext, ArrayList<Object> arrayList) throws Throwable {
		return notification(defaultContext, TypeConvertor.toString(arrayList.get(0)),
				TypeConvertor.toDate(arrayList.get(1)),
				TypeConvertor.toLong(arrayList.get(2)), TypeConvertor.toString(arrayList.get(3)),
				TypeConvertor.toString(arrayList.get(4)),TypeConvertor.toLong(arrayList.get(5)));
	}

	public Boolean notification(DefaultContext context, String optIds, Date sendTime, Long oid,
			String opinion, String billKey,Long workitemID) throws Throwable {
