 ...
 * 
 */
public class GetIdExistsSqlIncludeAll implements IExtService {
	@Override
	public Object doCmd(DefaultContext paramDefaultContext, ArrayList<Object> paramArrayList) throws Throwable {
		return getIdExistsSqlIncludeAll(paramDefaultContext, TypeConvertor.toString(paramArrayList.get(0)),
	 ...
	 * @throws Throwable
	 */
	public String getIdExistsSqlIncludeAll(DefaultContext context, String tableName, Object dicIds, String idName)
			throws Throwable {
		String sqlWhere = "";
