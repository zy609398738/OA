...
public class TSL_GetCostCenterDataTableImpl extends BaseMidFunctionImpl {
	private String ACTION = "ERP_CostCenter_TO_BPM";
	...
	public Object evalImpl(String name, DefaultContext context, Object[] args, IExecutor executor) throws Throwable {
		...
		String language = TypeConvertor.toString(context.getPara("Language"));
		...
		if (!Language.equalsIgnoreCase("null")) {
			...
			jo = factory.createCondition("language", " = ", Language);
			ja.add(jo);
		}
