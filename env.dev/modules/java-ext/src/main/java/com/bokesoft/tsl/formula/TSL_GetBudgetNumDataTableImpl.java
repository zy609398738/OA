...
public class TSL_GetBudgetNumDataTableImpl extends BaseMidFunctionImpl {
	private String ACTION = "ERP_BudgetNum_TO_BPM";
	...
	public Object evalImpl(String name, DefaultContext context, Object[] args, IExecutor executor) throws Throwable {
		...
		String oid1 = TypeConvertor.toString(context.getPara("oid"));
		...
		if (!oid1.isEmpty() && oid1 != null) {
			factory.addParameter("oid", oid1);
		}
