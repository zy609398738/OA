 ...
 *
 */
public class GetAuditNodeByProcessKey implements IExtService {
	@Override
	public Object doCmd(DefaultContext paramDefaultContext, ArrayList<Object> paramArrayList) throws Throwable {
		return getAuditNodeByProcessKey(paramDefaultContext,TypeConvertor.toString(paramArrayList.get(0)));
	}
	 ...
	 * @throws Throwable
	 */
	public String getAuditNodeByProcessKey(DefaultContext context,String workflowKey) throws Throwable {
		String dropItem = "";
		if(StringUtil.isBlankOrNull(workflowKey)){
			return dropItem;
		}
		MetaProcess process=context.getVE().getMetaFactory().getProcessDefinationByDeployKey(workflowKey);
		if(process ==null){
