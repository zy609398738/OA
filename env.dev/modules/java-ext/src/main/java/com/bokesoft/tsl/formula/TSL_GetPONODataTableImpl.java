...
public class TSL_GetPONODataTableImpl extends BaseMidFunctionImpl {
	private String ACTION = "ERP_PONO_To_BPM";
	...
	public Object evalImpl(String name, DefaultContext context, Object[] args, IExecutor executor) throws Throwable {
		...
		String headerid = TypeConvertor.toString(context.getPara("po_header_id"));
		...
		if (!headerid.isEmpty() && headerid != null) {
			jo = factory.createCondition("po_header_id", " = ", headerid);
			ja.add(jo);
		}
