 ...
 *
 */
public class TSL_GetDeptHeadParent extends BaseMidFunctionImpl {
	...
	public Object evalImpl(String name, DefaultContext context, Object[] args, IExecutor iExecutor) throws Throwable {
		...
		Long deptID = 0L;
		String sql = "select ParentID from OA_Department_H where oid = (select DeptID from OA_Employee_H where oid=? )";
