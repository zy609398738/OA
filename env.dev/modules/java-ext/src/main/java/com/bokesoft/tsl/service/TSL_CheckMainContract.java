...
public class TSL_CheckMainContract implements IExtService2 {
	private static String[] headFields = { "OU_NAME", "TradeTerms", "Currency",
			...
			"WithinCreditTerm", "OutofCreditTerm", "IsReplaced", "TotalCM",
	...
	public Object doCmd(DefaultContext context, Map<String, Object> args)
		...
		DataTable dataTableHead = document.get("B_SalContMainChg");
		DataTable dataTableDtl = document.get("B_SalContMainChgDtl");
		DataTable dataTableSP = document.get("B_SalContMainChgSP");
		DataTable dataTableOts = document.get("B_SalContMainChgOts");
