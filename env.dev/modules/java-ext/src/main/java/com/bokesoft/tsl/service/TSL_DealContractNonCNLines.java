...
public class TSL_DealContractNonCNLines implements IExtService2 {
	...
	public Object doCmd(DefaultContext context, Map<String, Object> args) throws Throwable {
		...
		DataTable headTable = document.get("B_SalContrNonCN");
		DataTable detailTable = document.get("B_SalContrNonCNDtl");
