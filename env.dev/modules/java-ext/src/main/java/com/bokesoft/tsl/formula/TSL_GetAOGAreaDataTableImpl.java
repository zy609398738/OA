...
public class TSL_GetAOGAreaDataTableImpl extends BaseMidFunctionImpl {

	private String ACTION = "ERP_AOGArea_TO_BPM";
	...
	public Object evalImpl(String name, DefaultContext context, Object[] args, IExecutor executor) throws Throwable {
		...
		String organization_id = TypeConvertor.toString(context.getPara("ouid"));
		...
		ja.add(jo);
		if (!organization_id.isEmpty() && !organization_id.equalsIgnoreCase("null")) {
