...
public class TSL_GetCashFlowStatementDataTableImpl extends BaseMidFunctionImpl {
	private String ACTION = "ERP_CashFlowStatement_TO_BPM";
	...
	public Object evalImpl(String name, DefaultContext context, Object[] args, IExecutor executor) throws Throwable {
		...
		String bu = TypeConvertor.toString(context.getPara("BU"));
