...
public class RoundImage extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		TypedArray a = mContext.obtainStyledAttributes(attrs,
				R.styleable.BKIM_RoundedImageView);
		mBorderThickness = a.getDimensionPixelSize(
				R.styleable.BKIM_RoundedImageView_border_thickness, 0);
		mBorderOutsideColor = a
				.getColor(R.styleable.BKIM_RoundedImageView_border_outside_color,
						defaultColor);
		mBorderInsideColor = a.getColor(
				R.styleable.BKIM_RoundedImageView_border_inside_color, defaultColor);
	}
