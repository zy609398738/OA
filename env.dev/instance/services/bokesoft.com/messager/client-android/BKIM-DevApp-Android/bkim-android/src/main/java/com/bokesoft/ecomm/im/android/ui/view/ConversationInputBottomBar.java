...
public class ConversationInputBottomBar extends LinearLayout {
  ...
  public ConversationInputBottomBar(Context context, AttributeSet attrs) {
    super(context, attrs);
    initView(context);
  }
    ...
    sendTextBtn.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (TextUtils.isEmpty(content)) {
          Toast.makeText(getContext(), R.string.bkim_message_is_null, Toast.LENGTH_SHORT).show();
          return;
        }
        ...
        EventBus.getDefault().post(
          new InputBottomBarTextEvent(InputBottomBarEvent.INPUTBOTTOMBAR_SEND_TEXT_ACTION,
            content, getTag()));
      }
    });
  ...
  private void initRecordBtn() {
    ...
    recordBtn.setRecordEventListener(new BKIMRecordButton.RecordEventListener() {
      @Override
      public void onFinishedRecord(final String audioPath, int secs) {
        EventBus.getDefault().post(
          new InputBottomBarRecordEvent(
            InputBottomBarEvent.INPUTBOTTOMBAR_SEND_AUDIO_ACTION, audioPath, secs, getTag()));
        recordBtn.setSavePath(PathUtils.getRecordPathByCurrentTime(getContext()));
      }
