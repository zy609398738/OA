package com.bokesoft.ecomm.im.orig.utils;
 ...
 * 语音播放相关的 helper 类
 */
public class BKIMAudioHelper {
  private static BKIMAudioHelper audioHelper;
  private MediaPlayer mediaPlayer;
  private AudioFinishCallback finishCallback;
  private String audioPath;
  private boolean onceStart = false;

  private BKIMAudioHelper() {
    mediaPlayer = new MediaPlayer();
  }

  public static synchronized BKIMAudioHelper getInstance() {
    if (audioHelper == null) {
      audioHelper = new BKIMAudioHelper();
    }
    return audioHelper;
  }
