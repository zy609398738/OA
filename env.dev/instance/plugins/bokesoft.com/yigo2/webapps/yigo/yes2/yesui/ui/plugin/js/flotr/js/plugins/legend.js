...
Flotr.addPlugin('legend', {
  options: {
    ...
    noColumns: 0,          // => number of colums in legend table // @todo: doesn't work for HtmlText = false
    ...
    backgroundColor: null/*'#F0F0F0'*/, // => Legend background color.
      ...
      if (!options.HtmlText && this.textEnabled && !legend.container) {
        ...
        for(i = 0; i < series.length; ++i){
          ...
          fragments.push(
            '<td class="flotr-legend-color-box">',
              '<div style="border:0px solid ', legend.labelBoxBorderColor, ';padding:1px">',
                '<div style="width:', boxWidth, 'px;height:', boxHeight, 'px;border:0px solid ', series[i].color, '">', // Border
        ...
        if(fragments.length > 0){
          ...
          if(legend.container){
            ...
            if(p == 'bottom') {
            	div.style.bottom = -35 + 'px';
            	div.style.left = 1/2 * (this.el.clientWidth - div.clientWidth) + 'px';
            } 
