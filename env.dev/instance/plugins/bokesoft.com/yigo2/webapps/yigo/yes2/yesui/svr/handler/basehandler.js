        ...
        doValueChanged: function (control, newValue, commitValue, fireEvent) {
            ...
            if (commitValue) {
                ...
                if (control.isSubDetail) {
                    ...
                    var grid = form.getComponent(control.parentGridKey), row, colInfoes, colInfo,
                    ...
                    if (grid && rowIndex >= 0 && rowIndex < grid.dataModel.data.length) {
                        if (isToDo) {
                            ...
                            if (colInfoes !== null) {
                                for (var ci = 0, clen = colInfoes.length; ci < clen; ci++) {
                                    ...
                                    grid.setValueAt(rowIndex, colInfo.colIndex, newValue, true, fireEvent);
                                }
                            }
                        } else {
                        ...
                        if (lastRowIndex != -1) {
                            ...
                            if (colInfoes !== null) {
                                ...
                                for (var ci = 0, clen = colInfoes.length; ci < clen; ci++) {
                                    colInfo = colInfoes[ci];
                                    grid.setValueAt(lastRowIndex, colInfo.colIndex, newValue, true, fireEvent);
                                }
                            }
                        }
                    }
