...
YIUI.Image = {
    VirtualDir: "/path",
    EmptyImg: "yesui/v2/yesui/ui/res/css/blue/images/empty.PNG",
    RootPath: "yesui/v2/",
    Style: "blue",
    getRealImagePath: function(fileName) {
        return this.RootPath + "yesui/ui/res/css/" + this.Style + "/images/" + fileName;
    }
};
/** form操作状态 */
