    ...
    }
    {
        ...
        var submit = function (btn, fileID, tableKey, path, cxt, quickSave) {
            ...
            $.ajaxFileUpload({
                ...
                secureuri: false,
                fileElement: btn,
                data: {service: "UploadAttachment", formKey: form.formKey, operatorID: $.cookie("userID"), fileID: fileID, poid: poid, quickSave: quickSave, oid: form.OID, tableKey: tableKey, path: path, mode: 1},
                type: "post",
