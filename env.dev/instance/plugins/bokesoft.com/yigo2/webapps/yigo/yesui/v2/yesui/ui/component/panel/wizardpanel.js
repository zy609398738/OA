YIUI.Panel.WizardPanel = YIUI.extend(YIUI.Panel, {
	   ...
	   onRender: function(ct) {
	    ...
	    afterRender : function(){
	    	...
	    	var divleft = $('<div class="wizard-btn left"><span class="btn-left"></span><span class="prev">'+YIUI.I18N.wizardpanel.previousStep+'</span></div>');
	    	var divright = $('<div class="wizard-btn right"><span class="btn-right"></span><span class="next">'+YIUI.I18N.wizardpanel.nextStep+'</span><span class="finish">'+YIUI.I18N.wizardpanel.complete+'</span></div>');
