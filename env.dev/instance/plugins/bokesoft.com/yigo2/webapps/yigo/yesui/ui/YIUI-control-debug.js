...
//            try {
                ...
                if (form.getUIProcess())
                    form.getUIProcess().resetUIStatus(YIUI.FormUIStatusMask.OPERATION);
...
(function () {
    ...
    YIUI.HostStatusProxy = YIUI.extend({
        ...
        validateEnable: function (key, content, context, formEnable) {
            var enableList = this.info["enableList"], match;
            return $.inArray(key, enableList) != -1;
        },
        validateEnableByTree: function (key, syntaxTree, context, formEnable) {
            var enableList = this.info["enableList"], match;
            return $.inArray(key, enableList) != -1;
        ...
        validateVisible: function (key, content, context) {
            var visibleList = this.info["visibleList"], match;
            return $.inArray(key, visibleList) == -1;
        },
        validateVisibleByTree: function (key, syntaxTree, context) {
            var visibleList = this.info["visibleList"], match;
            return $.inArray(key, visibleList) == -1;
...
//            this.dependencyProcess.cellValChanged(grid, rowIndex, colIndex, cellKey);
    ...
    YIUI.UIEnableProcess = function (form) {
        ...
        this.calcDetailRow = function (comp, subExpItem, sTrees, treeIndex, rowIndex, formEnable) {
            ...
            if (!comp.getRowDataAt(rowIndex).isDetail) return false;
...
//                } else {
//                    evalV = form.evalByTree(sTrees[treeIndex], {form: form, rowIndex: rowIndex}, null);
//                }
//            }
...
//                if (expItem.right.length !== 0) {
//                    if (expItem.right.toLowerCase() == "true" || expItem.right.toLowerCase() == "false") {
//                        enable = ( expItem.right.toLowerCase() == "true" );
//                    } else {
//                        enable = form.eval(expItem.right, {form: form}, null)
//                    }
//                }
//            }
