    ...
    Date.defaultFormat = "yyyy-MM-dd HH:mm:ss";
    ...
    function isHoliday(date) {
        ...
        var holidays = "#01_01#05_01#10_01#10_02#10_03#10_04#10_05#10_06#10_07";
        var ymd = "#" + date.getFullYear() + "_" + pad(date.getMonth() + 1) + "_" + pad(date.getDate()) + "#";
        var md = "#" + pad(date.getMonth() + 1) + "_" + pad(date.getDate()) + "#";
        var day = date.getDay();
        var isHoliday =  (day == 5 && friIsHoly) || (day == 6 && satIsHoly) || (day == 0 && sunIsHoly) || holidays.indexOf(ymd) > -1 || holidays.indexOf(md) > -1;
        return isHoliday || this.isHolitime(date);
    }

    function isHolitime(date) {
        return false;
    }
