		    ...
		    addNodes: function(nodes, pNodeKey, level, secondaryType, isNext) {
			    ...
			    if(this.showCheckBox) {
					...
					for (var i = 0, len = nodes.length; i < len; i++) {
			        	...
			        	if(nid in this.checkedNodes || noid in this.checkedNodes){
			        		chkstate = 1;
			        	}
...
//					}
		    ...
		    install: function() {
		        ...
		        this.dictTree._footdiv.delegate(".next", "click", function(){
		        	...
		        	self.dictTree.expandNode(self.dictTree.rootNode);
		        	var dictItemKey = self.dictTree.itemKey;
					var dnid = dictItemKey + "_" + 0;
...
//        this.setEditable(this.editable);
        ...
        this.setText(this.text);
        if (this.value != null){
        	if (this.value.length == 1 && this.value[0].oid == 0){
            	this.setText("全选");
            }
        }
...
YIUI.Control.Chart = YIUI.extend(YIUI.Control, {
	...
	setDraw : function(){
		...
		if(this.pie) {
			...
			//this.xScale = [[2015,1],[2016,2],[2017,4]];
    ...
    $.fn.yGrid = function (options) {
        ...
        return this.each(function () {
            ...
            if (this.p.showPager) {
                ...
                var toolbar = $("<div class='ui-ygrid-toolbar' style='width:100%;height:25px'></div>");
