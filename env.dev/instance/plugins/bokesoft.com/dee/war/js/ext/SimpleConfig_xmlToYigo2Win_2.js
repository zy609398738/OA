 ...
 * 配置的window
 */
function customedxmlToYigo2Win_2(text, description, record, detailId, detailType,
		newtablename, hidden) {
	var	treestore;
	var win_buttons = [{
		text : '保存',
		handler : function() {
			...
			Ext.Ajax.request({
				url : 'interfaceSimpleConfigCustomedXmlToYigo20Controller.do?actionType=updateSdInterfaceByIdAndType',
				params : {
