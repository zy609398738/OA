...
Ext.define('Ext.picker.DateTime', {
    ...
    initEvents: function(){
        ...
        //me.mon(me.eventEl, 'dblclick', me.handleDateClick,  me, {delegate: 'a.' + me.baseCls + '-date'});
    ...
    handleDateClick : function(e, t) {
        ...
        if(!me.disabled && t.dateValue && !Ext.fly(t.parentNode).hasCls(me.disabledCellCls)){
            ...
            me.activeDate.setHours(me.hour.getValue());
        	me.activeDate.setMinutes(me.minute.getValue());
        	me.activeDate.setSeconds(me.second.getValue());
            
            delete me.cancelFocus;
            me.fireEvent('select', me, me.activeDate);
            if (handler) {
                handler.call(me.scope || me, me, me.activeDate);
            }
