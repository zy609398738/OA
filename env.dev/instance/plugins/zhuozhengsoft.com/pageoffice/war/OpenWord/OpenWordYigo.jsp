...
String filePath = request.getParameter("filePath");//用request得到文件路径 
...
//******************************卓正PageOffice组件的使用*******************************
	...
	//打开文件
	poCtrl1.webOpen(basePath+"yigo/a/cms2-yigo2-adapter/cms/view-yigo-file/"+filePath, OpenModeType.docReadOnly, "张三");
